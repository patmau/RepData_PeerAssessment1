...
Mean number of steps per day: `r format(meanSteps)`  
...
Mean number of steps per day with imputation: `r format(impMeanSteps)`, compared to `r format(meanSteps)` without imputation.  
Median number of steps per day with imputation: `r impMedianSteps`, compared to `r medianSteps` without imputation.
